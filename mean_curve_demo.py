...
if __name__ == '__main__':
    ...
    mesh.boundary_box = (0,0,400,50)
    mesh.fixed_points = [(0,0),(400,0),(0,50),(400,50)]
    mesh.points, mesh.simplices = distmesh2d('square', mesh.boundary_box, mesh.fixed_points, l=0.2)
    mesh.set_edges()
...
#                            [7,8]])
    ...
    for j, functions in enumerate(function_sets):
        ...
        sparse_savetxt('/home/altaa/dumps1/b_matrix.txt', b_matrix)
        #np.savetxt('/home/altaa/dumps1/b_matrix.txt', b_matrix, fmt='%d', delimiter=' ')
        pdf_file.close()
        pdf_file = PdfPages('/home/altaa/figures11.pdf')
